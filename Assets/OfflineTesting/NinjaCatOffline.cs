...
public class NinjaCatOffline : PlayerControllerOffline
{
    ...
    [Header("inDash")]
    [SerializeField] UnityEvent TagStart;
    [SerializeField] UnityEvent TagEnd;
    [Header("Other")]
    ...
    void Start()
    {
        ...
        ability_tag = new Ability()
        {
            ...
            coolDown = .8f,
            events = new UnityEvent[] { TagStart, TagEnd }
        };
    }
